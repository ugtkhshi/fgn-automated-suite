...
test.describe('Partner Portal - Login page', () => {
 ...
 test('login with valid credentials and navigate to the dashboard', async ({ page }) => {
    ...
    await page.waitForURL('https://partners.uat.fastgamernetwork.com/document-library', { timeout: 2 * 60 * 1000, waitUntil: 'networkidle' });
